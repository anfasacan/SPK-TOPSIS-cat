...
<form method="POST" class="contact100-form validate-form" action="/compare_c_5" enctype="multipart/form-data">
    @csrf
    ...
    {{-- <div style="margin-top:20px; margin-left :40%; margin-right:10%"> --}}
       ...
       <br>
        <br>
        <span ><b>Masukan 5 Jenis Kucing untuk dibandigkan</b></span>
        <div>
          <select class="selection-2" name="kucing1" style="width: 10%">
            ...
            <select class="selection-2" name="kucing3" style="width: 10%">
              ...
              <select class="selection-2" name="kucing5" style="width: 10%">
                <option disabled selected value style="display: :none" >Pilih</option>
                @foreach ($data_kucing as $kucing5)
                <option>{{$kucing5->jenis_kucing}}</option>
                @endforeach
              </select>
        </div>    
    </div>
